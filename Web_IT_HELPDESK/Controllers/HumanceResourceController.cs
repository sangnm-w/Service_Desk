...
{
    public class HumanceResourceController : Controller
    {
        //
        // GET: /HumanceResource/
        ...
        {
            var album_list = en.Albums.Where(o => o.AlbumTypeId == 1).ToList();
        ...
        {
            var album_list = en.Albums.Where(i=>i.Title.Contains(searchString) && i.AlbumTypeId == 1).ToList();
            return View(album_list);
        }
