...
namespace Web_IT_HELPDESK.Models
{
    public class EmployeeModel
    {
        ...
        public List<EmployeeFieldModel> EmployeeFields()
        {
            ...
            var employeeFields = en.Employees.Select(e => new EmployeeFieldModel { Emp_CJ = e.Emp_CJ, EmployeeName = e.Employee_Name }).Distinct().ToList();
        ...
        public List<EmployeeFieldModel> EmployeeFieldsByPlant(string PlantId)
        {
            ...
            var employeeFields = en.Employees
